...
int Imagen::get_ancho() const
{
    return ancho;
}
void Imagen::set_ancho(int ancho_)
{
    ancho = ancho_;
}

int Imagen::get_alto() const
{
    return alto;
}
void Imagen::set_alto(int alto_)
{
    alto = alto_;
}

int Imagen::get_max_tam() const
{
    return max_tam;
}
void Imagen::set_max_tam(int maxTam)
{
    max_tam = maxTam;
}

Imagen::matriz_t Imagen::get_pixeles() const
{
